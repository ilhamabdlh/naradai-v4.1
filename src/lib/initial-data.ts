...
function buildKopiGoodDayInitial(base: DashboardContentStore): DashboardContentStore {
  ...
  return {
    ...
    outletSatisfaction: [],
    // ── Outlet Analysis overrides for Benings ────────────────────────────────
    outletStats: [
      {
        id: "1",
    ...
    outletRecentReviews: [
      ...
      },
      {
        ...
        sentiment: "positive",
        text:
          "Tempat nya nyaman , rapih , pelayananan nya oke dan memuaskan ga mengecewakan",
        stars: 5,
      },
      {
        id: "393",
    ...
    rawSourceContents: [
      ...
      },
      {
        ...
        content:
          "Treatment dan servicenya oke bgt. Tempatnya nyaman. Banyak promonya juga.",
        date: "01 Mar 2026",
        sentiment: 0.8,
        cluster: "Facility & Cleanliness",
        risk: "-",
      ...
      },
      {
        ...
        author: "vicha diaz",
        content:
          "Pelayanan ramah dr cs hingga dokternya, tempatnya bersih",
        date: "04 Mar 2026",
        sentiment: 0.8,
        cluster: "Facility & Cleanliness",
        risk: "-",
        opportunity: "Yes",
        rating: 5,
        outlet: "Bening's Clinic Sidoarjo",
      },
      {
        id: "src-436",
        platform: "Google Maps",
...
function buildBeningsInitial(d: DashboardContentStore): DashboardContentStore {
  return {
    ...
    statsOverview: [
      {
        ...
        value: "35.7%",
        description: "Positive sentiment ratio based on 199 validated mentions",
        icon: "TrendingUp",
      },
      {
        id: "2",
        ...
        value: "4",
        description: "Mentions flagged as 'High Risk'",
        icon: "AlertTriangle",
      },
      {
        id: "3",
        ...
        value: "18.1%",
        description: "Bening's Clinic SOV vs analyzed market",
        icon: "MessageSquare",
      },
      {
        id: "4",
        ...
        value: "1097",
        description: "Total validated mentions",
        icon: "Activity",
      },
    ],
    priorityActions: [
      ...
      },
      {
        id: "PA001",
        priority: "critical",
        title: "Immediate Admin Response Protocol",
        description:
          "Address unanswered reservations immediately to prevent customer churn and negative word-of-mouth.",
        impact: "High",
        effort: "Low",
        recommendation:
          "Implement a strict 15-minute SLA for WhatsApp and DM responses, and deploy an automated fallback chatbot for reservations.",
        category: "Customer Service",
        quadrantColor: "red",
        relatedIssues: ["Unanswered reservations", "Poor customer service"],
        metrics: {
          mentions: 45,
          sentiment: "-85%",
          trend: "Increasing",
      ...
      },
      {
        id: "PA002",
        priority: "high",
        title: "Post-Laser Diode Follow-up & Education",
        description:
          "Address clinical complaints regarding breakouts (bruntusan) after laser diode acne treatments.",
        impact: "High",
        effort: "Medium",
        recommendation:
          "Create automated post-treatment care guides sent via WhatsApp and mandate follow-up calls 3 days post-treatment.",
        category: "Clinical",
        quadrantColor: "orange",
        relatedIssues: ["Post-treatment breakouts", "Treatment efficacy"],
        metrics: {
          mentions: 28,
          sentiment: "-60%",
          trend: "Stable",
        ...
        sourceContent:
          "kak aku habis laser diode acne tp kok bruntusan malah tumbuh lagi?",
      },
    ],
    outletSatisfaction: [],
    risks: [
      {
        id: "R001",
        title: "Skepticism on Doctor's Credibility and Treatment Safety",
        description:
          "Netizens are questioning why clinic doctors do not undergo invasive procedures (OP) themselves, assuming there are hidden long-term risks.",
        severity: "High",
        probability: 0.8,
        impact: "Reputational damage and loss of trust in high-ticket aesthetic treatments.",
        trend: "Increasing",
        supportingContents: 64,
        indicators: [
          {
        ...
        metrics: { trustSentimentChange: -15 },
        mitigation: [
          "Launch a 'Doctor's Routine' campaign showing doctors using and trusting Bening's non-invasive treatments.",
          "Educate the public on the safety and benefits of non-invasive clinic treatments versus plastic surgery.",
        ],
        sourceContent: [
          {
            id: "r1-1",
            platform: "social_media",
            author: "anonymous_netizen",
            content:
              "Yg aku fokus ke dokternya dia aja gak mau OP krn mungkin tahu resiko jangka panjang",
            sentiment: -0.6,
            timestamp: "Mar 2026",
            engagement: { likes: 0, replies: 0, retweets: 0 },
          },
    ...
    opportunities: [
      {
        id: "O001",
        title: "Positioning Non-Invasive Treatments as the Safe Alternative",
        description:
          "Leverage the public's fear of long-term surgery (OP) risks to promote Bening's non-invasive, safe, and scientifically backed treatments.",
        potential: "High",
        confidence: 0.85,
        timeframe: "Short Term",
        category: "Marketing",
        ...
        metrics: { sentimentScore: 75, marketPotentialIndex: 3, reachGrowthIndex: 1 },
        recommendations: [
          "Create content highlighting why Bening's doctors prefer non-invasive laser and skincare treatments over surgery.",
          "Highlight the long-term safety profiles of Bening's flagship treatments.",
        ],
        sourceContent: [
          {
            id: "o1-1",
            platform: "social_media",
            author: "market_trend_analyzer",
            content:
              "Yg aku fokus ke dokternya dia aja gak mau OP krn mungkin tahu resiko jangka panjang",
            sentiment: 0.75,
            timestamp: "Mar 2026",
      ...
      {
        id: "O002",
        title: "Competitor Hijack: TikTok Diet & Nutrition Trend",
        description:
          "Airin is currently dominating the Share of Voice (323 mentions) through a viral 'Airin Gizi Clinic' campaign on TikTok, promoting weight loss programs without extreme dieting. Bening's Clinic can capture this engaged audience by heavily promoting our slimming/body contouring treatments as a faster, non-diet alternative.",
        potential: "High",
        confidence: 0.95,
        timeframe: "Immediate",
        category: "Marketing Campaign",
        trend: "Trending",
        supportingContents: 323,
        metrics: { sentimentScore: 0, marketPotentialIndex: 4, reachGrowthIndex: 2 },
        recommendations: [
          "Immediately launch a counter-campaign on TikTok highlighting Bening's slimming treatments (e.g., X-Wave, Emsculpt).",
          "Utilize the marketing angle: 'No need to wait months, achieve your ideal body shape faster with Bening's technology'.",
          "Deploy KOLs/Influencers to compare diet results vs. clinic treatment results to hijack the current TikTok hype.",
        ],
        sourceContent: [
          {
            id: "o2-1",
            platform: "tiktok",
            author: "Market Intelligence (Airin)",
            content:
              "TUTORIAL TURUNIN BRAT BADAN 14kg... di @airin.giziklinik. Tanpa diet ekstrem...",
            sentiment: 0,
            timestamp: "Mar 2026",
            engagement: { likes: 14900, replies: 2454, retweets: 0 },
          },
        ],
      },
    ],
    competitiveIssues: [
      {
        id: "1",
        issue: "Customer Service & Staff",
        category: "Customer Service & Staff",
        yourSentiment: -1.4,
        competitorMedianSentiment: 35.5,
        yourMentions: 7,
        competitorMedianMentions: 7.0,
        relativeSentiment: -103.9,
        relativeMentions: 0.0,
      },
      {
        id: "2",
        issue: "Facilities",
        category: "Facilities",
        yourSentiment: 5.5,
        competitorMedianSentiment: 10.3,
        yourMentions: 20,
        competitorMedianMentions: 2.5,
        relativeSentiment: -46.9,
        relativeMentions: 700.0,
      },
      {
        id: "3",
        ...
        yourSentiment: 5.5,
        competitorMedianSentiment: 5.5,
        yourMentions: 65,
        competitorMedianMentions: 9.5,
        relativeSentiment: -0.9,
        relativeMentions: 584.2,
      },
      {
        id: "4",
        issue: "Pricing & Promo",
        ...
        yourSentiment: 23.4,
        competitorMedianSentiment: 50.8,
        yourMentions: 44,
        competitorMedianMentions: 35.0,
        relativeSentiment: -53.9,
        relativeMentions: 25.7,
      },
      {
        id: "5",
        issue: "Treatment & Product Quality",
        category: "Treatment & Product Quality",
        yourSentiment: 46.3,
        competitorMedianSentiment: 52.0,
        yourMentions: 63,
        competitorMedianMentions: 21.5,
        relativeSentiment: -11.0,
        relativeMentions: 193.0,
      },
    ],
    competitiveKeyInsights: [
      {
    ...
    whatsHappeningSentimentTrends: [
      { date: "Feb 25", positive: 13, negative: 2, neutral: 2 },
      { date: "Feb 26", positive: 21, negative: 0, neutral: 6 },
      { date: "Feb 27", positive: 24, negative: 0, neutral: 15 },
      { date: "Feb 28", positive: 17, negative: 0, neutral: 14 },
      { date: "Mar 01", positive: 12, negative: 2, neutral: 14 },
      { date: "Mar 02", positive: 19, negative: 0, neutral: 12 },
      { date: "Mar 03", positive: 14, negative: 2, neutral: 13 },
      { date: "Mar 04", positive: 24, negative: 1, neutral: 33 },
      { date: "Mar 05", positive: 20, negative: 0, neutral: 19 },
      { date: "Mar 06", positive: 27, negative: 0, neutral: 23 },
      { date: "Mar 07", positive: 21, negative: 0, neutral: 36 },
      { date: "Mar 08", positive: 20, negative: 2, neutral: 30 },
      { date: "Mar 09", positive: 40, negative: 3, neutral: 44 },
      { date: "Mar 10", positive: 41, negative: 2, neutral: 65 },
      { date: "Mar 11", positive: 49, negative: 7, neutral: 98 },
      { date: "Mar 12", positive: 74, negative: 8, neutral: 130 },
      { date: "Mar 13", positive: 27, negative: 1, neutral: 50 },
    ],
    whatsHappeningKeyEvents: [
      {
        id: "1",
        date: "Today",
        title: "Admin Unresponsiveness Spike",
        description:
          "Multiple reports of customers failing to get responses for reservations, indicating a bottleneck in customer service operations.",
      },
      {
        id: "2",
        date: "Today",
        title: "Doctor Credibility Questioned",
        description:
          "Viral social media discussions questioning why aesthetic doctors avoid invasive procedures, sparking debates on long-term risks.",
      },
    ],
    whatsHappeningTopTopics: [
      { topic: "Pricing & Promo", mentions: 372, sentiment: 34.5 },
      { topic: "General Inquiry", mentions: 287, sentiment: 6.0 },
      { topic: "Treatment & Product Quality", mentions: 260, sentiment: 51.7 },
      { topic: "Facilities", mentions: 111, sentiment: 11.1 },
      { topic: "Customer Service & Staff", mentions: 67, sentiment: 34.8 },
    ],
    whatsHappeningAITopicAnalysis: [
      {
        id: "T001",
        type: "insight",
        title: "Doctor Credibility & Trust",
        description:
          "Users expressing skepticism about treatments because doctors don't seem to use them or alter their own faces.",
      },
      {
        id: "T002",
        type: "insight",
        ...
        description:
          "Complaints about admins ignoring reservation requests across digital channels.",
      },
      {
        id: "T003",
        type: "insight",
        title: "Post-Laser Breakouts",
        description:
          "Patients experiencing purging or breakouts after Diode Acne Laser treatments.",
      },
    ],
    whatsHappeningTopicTrendsData: [
      {
      ...
      },
      {
        ...
        "General Inquiry": 4,
        "Pricing & Promo": 11,
        "Treatment & Product Quality": 8,
      },
      {
        date: "Mar 01",
        "Customer Service & Staff": 4,
        Facilities: 4,
        "General Inquiry": 4,
        "Pricing & Promo": 11,
        "Treatment & Product Quality": 5,
      },
      {
        date: "Mar 02",
        "Customer Service & Staff": 0,
        Facilities: 4,
        "General Inquiry": 4,
        "Pricing & Promo": 18,
        "Treatment & Product Quality": 5,
      ...
      },
      {
        ...
        "General Inquiry": 9,
        "Pricing & Promo": 27,
        "Treatment & Product Quality": 13,
      },
      {
        date: "Mar 05",
        "Customer Service & Staff": 5,
        Facilities: 2,
        "General Inquiry": 8,
        "Pricing & Promo": 18,
        "Treatment & Product Quality": 6,
      },
      {
        date: "Mar 06",
        "Customer Service & Staff": 1,
      ...
      {
        date: "Mar 11",
        "Customer Service & Staff": 7,
        Facilities: 18,
        "General Inquiry": 46,
        "Pricing & Promo": 47,
        "Treatment & Product Quality": 36,
      },
      {
        date: "Mar 12",
        "Customer Service & Staff": 18,
        Facilities: 8,
        "General Inquiry": 85,
        "Pricing & Promo": 58,
        "Treatment & Product Quality": 43,
      },
      {
        date: "Mar 13",
        "Customer Service & Staff": 7,
    ...
    whatsHappeningAITrendAnalysis: [
      {
        id: "TR001",
        type: "insight",
        title: "Preference for Non-Invasive over Surgery",
        description:
          "Consumers are highly aware and fearful of the long-term risks of plastic surgery (OP).",
      },
    ],
    whatsHappeningWordCloud: [
    ...
    whatsHappeningClusters: [
      {
        id: "1",
        theme: "Trust & Doctor Authenticity",
        size: 45,
        sentiment: 0.2,
        trend: "upward",
        keywords: ["dokter", "muka", "efek", "OP", "resiko"],
      },
      {
        id: "2",
        theme: "Treatment Efficacy & Side Effects",
        size: 30,
        sentiment: 0.3,
        trend: "stable",
        keywords: ["laser", "diode", "acne", "bruntusan", "tumbuh"],
      },
      {
        id: "3",
        theme: "Operational Bottlenecks",
        size: 25,
        sentiment: 0.1,
        trend: "upward",
        keywords: ["reservasi", "admin", "dijawab", "balas"],
      },
    ],
    whatsHappeningHashtags: [
      { id: "1", tag: "#fyp", conversations: 48, likes: 0, comments: 0 },
      { id: "2", tag: "#skinmology", conversations: 39, likes: 0, comments: 0 },
      { id: "3", tag: "#lockyourbright", conversations: 38, likes: 0, comments: 0 },
      { id: "4", tag: "#CantikSaatLebaran", conversations: 30, likes: 0, comments: 0 },
      { id: "5", tag: "#skincare", conversations: 28, likes: 0, comments: 0 },
    ],
    whatsHappeningAccounts: [
      {
        id: "169",
        name: "derma_express",
        handle: "@derma_express",
      ...
      {
        id: "455",
        name: "natashaskincare",
        handle: "@natashaskincare",
        platform: "Instagram Post",
        followers: 0,
        conversations: 34,
        likes: 3034,
      ...
      {
        id: "226",
        name: "erhaskincare_id",
        handle: "@erhaskincare_id",
        platform: "TikTok Video",
        followers: 0,
        conversations: 20,
        likes: 132,
    ...
    whatsHappeningContents: [
      {
        id: "1186",
        title: "TUTORIAL TURUNIN BRAT BADAN 14kg > Dari ...",
        platform: "TikTok Video",
        author: "airinskinclinic",
        likes: 14900,
        comments: 2454,
      },
      {
        id: "630",
        title: "emang harus berubah jadi sumala dulu bua...",
        platform: "TikTok Video",
        author: "sozo.skin.clinic",
        likes: 13900,
        comments: 779,
      },
      {
        id: "475",
        title: "RABU 11 MART \nHARI K7 STLAH OPLAS DI @de...",
        platform: "TikTok Video",
        author: "pikbakinghouse",
        likes: 5950,
        comments: 740,
      },
      {
        id: "1131",
        title: "Siapa nih yang punya temen wacana ngabub...",
        platform: "Instagram Post",
        author: "sibuntels",
        likes: 3702,
        comments: 60,
    ...
    whatsHappeningAIKOLAnalysis: [
      {
        id: "K001",
        type: "insight",
        title: "Doctor-led KOL Strategy",
        description:
          "Audiences are looking for authentic proof from medical professionals, not just celebrity influencers. Deploy Bening's in-house doctors as KOLs.",
      },
    ],
    whatsHappeningShareOfPlatform: [
      {
...
function buildBeningsCampaignInitial(d: DashboardContentStore): DashboardContentStore {
  return {
    ...
    campaignStats: [
      {
        ...
        positive: true,
        description:
          "Positive sentiment ratio for #beningsindonesia posts and linked comments",
        icon: "TrendingUp",
      },
      {
        id: "2",
        ...
        change: "+306",
        positive: true,
        description: "Total organic likes garnered by the campaign",
        icon: "Heart",
      },
      {
        id: "3",
        ...
        change: "+108",
        positive: true,
        description: "Sum of all replies (54) and shares (54)",
        icon: "MessageSquare",
      },
      {
        id: "4",
        ...
        change: "+16",
        positive: true,
        description: "Total campaign posts and child comments analyzed",
        icon: "Activity",
      },
    ],
    campaignPerformance: [
    ...
    campaignTrendData: [
      { id: "1", month: "Feb 2026", likes: 110, shares: 34, replies: 47 },
      { id: "2", month: "Mar 2026", likes: 222, shares: 6, replies: 5 },
    ],
    campaignTimeSeriesData: [
      { id: "1", date: "25 Feb", likes: 0, replies: 0, shares: 0 },
      { id: "2", date: "26 Feb", likes: 110, replies: 47, shares: 34 },
      { id: "3", date: "27 Feb", likes: 0, replies: 0, shares: 0 },
      { id: "4", date: "28 Feb", likes: 0, replies: 0, shares: 0 },
      { id: "5", date: "01 Mar", likes: 11, replies: 0, shares: 0 },
      { id: "6", date: "02 Mar", likes: 0, replies: 0, shares: 0 },
      { id: "7", date: "03 Mar", likes: 15, replies: 0, shares: 0 },
      { id: "8", date: "04 Mar", likes: 94, replies: 1, shares: 5 },
      { id: "9", date: "05 Mar", likes: 11, replies: 0, shares: 0 },
      { id: "10", date: "06 Mar", likes: 14, replies: 2, shares: 0 },
      { id: "11", date: "07 Mar", likes: 0, replies: 0, shares: 0 },
      { id: "12", date: "08 Mar", likes: 5, replies: 0, shares: 0 },
      { id: "13", date: "09 Mar", likes: 3, replies: 0, shares: 0 },
      { id: "14", date: "10 Mar", likes: 16, replies: 0, shares: 1 },
      { id: "15", date: "11 Mar", likes: 3, replies: 0, shares: 0 },
      { id: "16", date: "12 Mar", likes: 26, replies: 1, shares: 0 },
      { id: "17", date: "13 Mar", likes: 24, replies: 1, shares: 0 },
    ],
    campaignPostPublishEvents: [
    ...
    campaignReplyTopics: [
      {
        id: "1",
        topic: "Product Pricing & Ordering Inquiries",
        totalReplies: 182,
        positive: "35.0%",
        neutral: "60.0%",
        negative: "5.0%",
        topComments: [
          "hrga sepaket ny brp ka ?",
          "mau oder gimana caranya kak",
          "bisa COD atau kirim ke Taiwan gak kak?",
        ],
      },
      {
        id: "2",
        topic: "Customer Testimonials & Experience",
        totalReplies: 135,
        positive: "98.0%",
        neutral: "2.0%",
        negative: "0.0%",
        topComments: [
          "Alhamdulillah sy pake benings udan 1 tahun hasilx Alhamdulillah puas",
          "Benings emang skincare paling bagus, mencerahkan banget",
          "Aaaa dr 3tahun pakai benings memang aman terbenings2",
        ],
      },
      {
        id: "3",
        topic: "Skincare Consultations (Acne & Dark Spots)",
        totalReplies: 70,
        positive: "45.0%",
        neutral: "45.0%",
        negative: "10.0%",
        topComments: [
          "buat muka flek hitam, tpi hidung berminyak... cocok pake paket yng mna ya ka?",
          "Buat ibu hamil aman gak?? Pngen glowing krna smnjk hamil muka kusam",
          "kalau untuk usia 40 an ada flek hitam... pake apa ya kak??",
        ],
      },
      {
        id: "4",
        topic: "Product Issues & Incompatibility",
        totalReplies: 38,
        positive: "0.0%",
        neutral: "10.0%",
        negative: "90.0%",
        topComments: [
          "pernah pake bening's skincare,malah gatal gatal..jd aku stop",
          "aku jg gk cocok ... malah brruntusan, jerawat, kusam",
          "Peke bening's skincare malah gatal2 dan muncul bintik2 merah, kenapa yah ??",
        ],
      },
    ],
    campaignContentTypes: [
      {
        id: "1",
        type: "Product Education (Deep Moisture Gel)",
        platform: "Instagram",
        posts: 7,
        likes: 63,
        shares: 0,
        replies: 1,
        positiveSentiment: "94.5%",
        ...
        audienceReaction:
          "Informative and educational; audiences are highly curious about specific ingredients and hydration benefits for dry skin.",
      },
      {
        id: "2",
        type: "Holiday/Theme Promotion (Glow Up Lebaran)",
        platform: "TikTok",
        posts: 1,
        likes: 94,
        shares: 5,
        replies: 1,
        positiveSentiment: "96.0%",
        negativeSentiment: "0.0%",
        topTopics: ["Lebaran", "Glowing", "Eid Season", "Holiday Prep"],
        audienceReaction:
          "High seasonal relevance; the 'Glow Up for Lebaran' hook creates high desire and urgency within the TikTok community.",
      },
      {
        id: "3",
        type: "Conversion & Sales Support",
        platform: "TikTok",
        posts: 2,
        likes: 26,
        shares: 3,
        replies: 4,
        positiveSentiment: "85.0%",
        negativeSentiment: "0.0%",
        topTopics: ["Keranjang Kuning", "Yellow Cart", "Shopee Live", "Order Now"],
        audienceReaction:
          "Direct transactional intent; users are redirected to e-commerce channels, resulting in direct inquiries about purchasing methods.",
      },
    ],
    campaignTopPosts: [
      {
        id: "1",
        type: "video",
        title: "Paket Glowing Lebaran - Keranjang Kuning",
        platform: "TikTok",
        likes: 94,
        shares: 5,
        replies: 1,
      ...
      },
      {
        id: "2",
        type: "video",
        title: "Solution for Dull and Kusam Skin",
        platform: "TikTok",
        likes: 47,
        shares: 30,
        replies: 39,
      ...
      },
      {
        id: "3",
        type: "image",
        title: "Skinmology Deep Moisture Gel Education",
        platform: "Instagram",
        likes: 24,
        shares: 0,
        replies: 1,
    ...
    campaignCompetitors: [
      {
        id: "1",
        brand: "Bening's Clinic (#beningsindonesia Campaign)",
        posts: 16,
        likes: 332,
        replies: 52,
        shares: 40,
    ...
    campaignRecommendations: [
      {
        id: "1",
        priority: "high",
        title: "Optimize Conversion for Pricing Inquiries",
        detail:
          "With 182 comments inquiring about prices and order methods, there is a significant conversion gap. Implement automated 'Direct Response' or clear 'Price Lists' in TikTok captions to capture these high-intent leads immediately.",
        impact: "High",
      },
      {
        id: "2",
        priority: "high",
        title: "Medical Mitigation for Incompatibility Concerns",
        detail:
          "Address the 8.9% negative sentiment regarding itching and breakouts. Create 'Doctor Education' content to explain the 'purging' phase and manage patient expectations to prevent churn and reputational damage.",
        impact: "High",
      },
    ],
  };
...
function buildBeningsLockYourBrightCampaignInitial(d: DashboardContentStore): DashboardContentStore {
  return {
    ...d,
    campaignStats: [
      {
        ...
        positive: true,
        description:
          "High positive sentiment driven by giveaway enthusiasm and consumer research participation",
        icon: "TrendingUp",
      },
      {
        id: "2",
        ...
        change: "+2682",
        positive: true,
        description: "Total validated likes across all #lockyourbright content",
        icon: "Heart",
      },
      {
        id: "3",
        ...
        change: "+646",
        positive: true,
        description: "Sum of all replies (589) and shares (57)",
        icon: "MessageSquare",
      },
      {
        id: "4",
        ...
        positive: true,
        description:
          "Total campaign posts and community response comments analyzed",
        icon: "Activity",
      },
    ],
    campaignPerformance: [
    ...
    campaignTrendData: [
      { id: "1", month: "Feb 2026", likes: 1358, shares: 10, replies: 194 },
      { id: "2", month: "Mar 2026", likes: 1324, shares: 47, replies: 395 },
    ],

    campaignTimeSeriesData: [
      { id: "1", date: "25 Feb", likes: 0, replies: 0, shares: 0 },
      { id: "2", date: "26 Feb", likes: 1288, replies: 188, shares: 0 },
      { id: "3", date: "27 Feb", likes: 70, replies: 6, shares: 10 },
      { id: "4", date: "28 Feb", likes: 0, replies: 0, shares: 0 },
      { id: "5", date: "01 Mar", likes: 47, replies: 4, shares: 2 },
      { id: "6", date: "02 Mar", likes: 0, replies: 0, shares: 0 },
      { id: "7", date: "03 Mar", likes: 15, replies: 0, shares: 0 },
      { id: "8", date: "04 Mar", likes: 108, replies: 3, shares: 5 },
      { id: "9", date: "05 Mar", likes: 11, replies: 0, shares: 0 },
      { id: "10", date: "06 Mar", likes: 47, replies: 4, shares: 2 },
      { id: "11", date: "07 Mar", likes: 0, replies: 0, shares: 0 },
      { id: "12", date: "08 Mar", likes: 10, replies: 0, shares: 0 },
      { id: "13", date: "09 Mar", likes: 6, replies: 0, shares: 0 },
      { id: "14", date: "10 Mar", likes: 403, replies: 15, shares: 8 },
      { id: "15", date: "11 Mar", likes: 3, replies: 0, shares: 0 },
      { id: "16", date: "12 Mar", likes: 653, replies: 372, shares: 0 },
      { id: "17", date: "13 Mar", likes: 21, replies: 1, shares: 30 },
    ],
    campaignChannels: [
      {
        id: "1",
    ...
    campaignCompetitors: [
      {
        id: "1",
        brand: "Bening's Clinic (Campaign)",
        posts: 49,
        likes: 2682,
        replies: 589,
        shares: 57,
    ...
    campaignReplySentiment: { positive: 92, neutral: 8, negative: 0 },
    campaignReplyTopics: [
      {
        id: "1",
        topic: "Giveaway Participation (Done/First)",
        totalReplies: 372,
        positive: 95,
        neutral: 5,
        negative: 0,
        topComments: [
          "Done min! ✨",
          "Momen Ramadan paling berkesan bagiku adalah...",
          "Semoga beruntung dapat THR Skinmology",
        ],
      },
      {
        id: "2",
        topic: "Consumer Research Participation",
        totalReplies: 188,
        positive: 90,
        neutral: 10,
        negative: 0,
        topComments: [
          "Link kuesioner sudah diisi kak",
          "Done kuesioner, semoga terpilih!",
          "Sudah scan QR, cepat banget isinya",
        ],
      },
    ],
    campaignContentTypes: [
      {
        id: "1",
        type: "Interactive Giveaway",
        platform: "Instagram",
        posts: 2,
        likes: 1311,
        shares: 0,
        replies: 466,
        positiveSentiment: 98,
        negativeSentiment: 0,
        topTopics: ["THR", "Skinmology", "Ramadan Story"],
        audienceReaction:
          "Massive engagement; participants are highly motivated to share personal stories for a chance to win prizes.",
      },
      {
        id: "2",
        ...
        negativeSentiment: 0,
        topTopics: ["Questionnaire", "QR Code", "Product Research"],
        audienceReaction:
          "Targeted interaction; users show high willingness to participate in surveys for small incentives.",
      },
    ],
    campaignTopPosts: [
      {
        id: "1",
        type: "image",
        title: "Giveaway: Berbagi THR Bareng SKINMOLOGY",
        platform: "Instagram",
        likes: 667,
        shares: 0,
        replies: 372,
      ...
      },
      {
        id: "2",
        type: "image",
        title: "3-Minute Consumer Research Survey",
        platform: "Instagram",
        likes: 644,
        shares: 0,
        replies: 94,
    ...
    campaignRecommendations: [
      {
        id: "1",
        priority: "high",
        title: "Scale Instagram Giveaway Model",
        detail:
          "The 'Berbagi THR' mechanic generated 667 likes and 372 comments in one post. This high-interaction format should be standardized for holiday-themed campaigns to maintain top-of-mind brand awareness.",
        impact: "High",
      },
      {
        id: "2",
        priority: "medium",
        title: "Utilize Research Insights for Ad Copy",
        detail:
          "Leverage data from the 188+ survey participants to refine future ad copy for the #lockyourbright campaign, ensuring marketing messages align with actual consumer skin concerns identified in the research.",
        impact: "High",
      },
    ],
  };
...
export function getInitialDashboardContentForInstance(instanceId: string, defaultContent: DashboardContentStore): DashboardContentStore | null {
  ...
  if (instanceId === "benings_campaign_analysis_01_2026" || instanceId === "benings_campaign_beningsindonesia_tracker")
    return buildBeningsCampaignInitial(defaultContent);
  if (instanceId === "benings_campaign_lockyourbright_tracker")
    return buildBeningsLockYourBrightCampaignInitial(defaultContent);
